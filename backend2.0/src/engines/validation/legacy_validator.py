"""
Strict validation used by the legacy backend for retry logic.

Requires positive area_sqft on every room — encourages the model to return
complete dimension sets before we accept a page result.
"""
from __future__ import annotations


def validate_legacy_analysis(data: dict) -> bool:
