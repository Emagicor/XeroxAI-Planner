...
from infrastructure.annotations.fonts import get_font
...
def draw_room_card(
    ...
    length_ft = room.get("length_ft") or "—"
    width_ft = room.get("width_ft") or "—"
    area_sqft = room.get("area_sqft") if room.get("area_sqft") is not None else "—"
