  ...
  return (
    <div className="mt-4 rounded-xl border border-dashed border-line bg-card/60 p-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <p className="text-sm font-medium text-text">Ground truth JSON</p>
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="px-4 py-2 rounded-lg border border-line bg-surface text-sm text-text hover:border-accent/50"
          >
          ...
          {names.length > 0 && (
            <button
              ...
              className="px-4 py-2 rounded-lg text-sm text-muted hover:text-red-400"
            >
              Clear
            </button>
          )}
