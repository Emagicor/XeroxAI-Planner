    ...
    <div className="w-full">
      {src ? (
        <img
          ...
          className="w-full rounded-xl border border-line shadow-xl bg-[#1a1a18]"
          onError={() => setImgError(true)}
        />
      ) : (
        <div className="w-full aspect-[4/3] rounded-xl border border-line bg-card/50 flex items-center justify-center text-[#8B8A82] text-sm">
