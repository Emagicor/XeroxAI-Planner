    ...
    <div className="bg-card border border-line rounded-xl overflow-hidden">
      <div className="flex items-center justify-between px-4 py-3 border-b border-line">
        <p className="text-sm text-muted">
          Check <span className="text-text">Include</span> to count a room in
          totals and exports.
        </p>
        <Button variant="secondary" size="sm" onClick={() => onAddRoom(activePage)}>
          + Add room
        </Button>
      </div>
                ...
                >
                  ...
                  <td className="px-3 py-2">
                    <input
                      ...
                      className="w-full min-w-[100px] bg-surface border border-line rounded px-2 py-1 text-text"
                    />
                  </td>
                  <td className="px-3 py-2">
                    <input
